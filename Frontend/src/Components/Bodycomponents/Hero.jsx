            ...
            <section id="hero">
                <div className="container flex flex-col-reverse md:flex-row items-center  px-6 mx-auto mt-10 space-x-0 md:space-y-0">
                    ...
                    <div className="lg:px-16">
                        <h2 className="mb-4 max-w-md text-3xl font-bold text-center md:text-left lg:mt-24">Drive Your Dream Car Today!</h2>
                        ...
                        <p className="mb-16 font-sans text-[gray] text-xl text-center md:text-left">Rent the car of your dreams. Unbeatable prices, unlimited miles,hassle free booking, flexible pick-up options and much more.</p>
                    ...
                    <div className='hidden md:flex flex-col mb-32 space-y-12  md:w-1/2 '>
                        <img className="red-car" src={car} alt="car"/>
                    </div>
                </div>
            </section>
        </>
