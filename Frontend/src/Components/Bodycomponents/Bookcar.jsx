...
export default function Bookcar({
  ...
  return (
    <>
      {isDivVisible && (
        <div
          className="container border-4 border-white shadow-2xl overflow-x-hidden mx-auto bg-white absolute z-50 w-3/5 flex flex-col justify-center items-center"
          style={{
            top: "170%",
            left: "50%",
        ...
        >
          <div className="flex justify-between px-4 py-2 bg-orange w-full">
            <h2 className="font-bold font-sans text-3xl text-white">
          ...
          <div className="grid lg:grid-cols-2 w-full border-b">
            <div className="justify-start py-4 px-4 w-full bg-white">
              <h2 className="text-orange  font-bold font-sans text-xl">
                Location & Date
              </h2>
              <h3 className="py-2 font-bold font-sans text-lg">
                <CalendarMonthOutlinedIcon className="text-[#000]" /> Pick up
                Date & Time
              </h3>
              <p className="text-base px-2 text-[#777] font-sans">
                {pickDate} /{" "}
              </p>
              <input
                value={pickTime}
              ...
              />
              <h3 className="py-2 font-bold font-sans text-lg">
                <CalendarMonthOutlinedIcon className="text-[#000]" /> Drop of
                Date & Time
              </h3>
              <p className="text-base px-2 text-[#777] font-sans">
                {dropDate} /
              ...
              />
              <h3 className="py-2 font-bold font-sans text-lg">
                <LocationOnOutlinedIcon className="text-[#000]" /> Pick up
                Location
              </h3>
              <p className="text-base px-2 text-[#777] font-sans">
                {pickPlace}
              ...
              <h3 className="py-2 font-bold font-sans text-lg">
                <LocationOnOutlinedIcon className="text-[#000]" /> Drop of
                Location
              </h3>
              <p className="text-base px-2 text-[#777] font-sans">
                {dropPlace}
            ...
            <div className="justify-center py-4 px-4 w-full bg-white">
              <h2 className="font-bold font-sans text-lg">
                Car -{" "}
                <span className="text-orange font-bold font-sans text-lg">
                  {carType}
                </span>
              </h2>
          ...
          <h2 className="text-orange py-4 font-bold font-sans text-xl">
            Personal Information
          </h2>
          <div className="grid lg:grid-cols-2 w-full bg-white">
            <div className="py-2 px-4">
              <label className="text-lg text-[#777] mx-2 font-semibold font-sans">
                First Name
              </label>
              <br />
              <input
